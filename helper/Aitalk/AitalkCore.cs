// Ported from https://github.com/Nkyoku/voiceroid_daemon (Aitalk/source/AitalkCore.cs)
// 元実装の P/Invoke 定義を helper のために移植したもの。
// VOICEROID2 同梱の aitalked.dll は x86 stdcall。csproj 側で <PlatformTarget>x86</PlatformTarget> を必ず維持すること。
#nullable disable
using System;
